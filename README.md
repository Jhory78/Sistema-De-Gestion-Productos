...
- Búsqueda **lineal** por fabricante y tipo
- Resultados de búsqueda separados del listado principal
- Implementación modular con clases independientes
- Programación orientada a eventos (interfaz interactiva)
